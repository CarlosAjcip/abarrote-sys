...
<div class="container-fluid px-4">
    ...
    <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
        <form action="{{route('cliente.update', ['cliente' => $cliente])}}" method="post">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                        <label for="tipo_persona" class="form-label">Tipo Cliente: <span class="fw-bold">{{Str::upper($cliente->persona->tipo_persona)}}</span></label>
                </div>
                ...
                <div class="col-md-12 mb-2" id="box-razon-social">
                    ...
                    <input type="text" name="razon_social" class="form-control" value="{{old('razon_social', $cliente->persona->razon_social)}}">
