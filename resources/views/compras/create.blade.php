            ...
            <div class="col-xl-4">
                ...
                <div class="p-3 border border-3 border-success">
                    <div class="row">
                        ...
                        <!--Tipo de comprobante-->
                        <div class="col-12 mb-2">
                            <label for="comprobantes_id" class="form-label">Comprobante:</label>
                            <select name="comprobantes_id" id="comprobantes_id" class="form-control selectpicker" title="Selecciona">
